...
<table class="table"><form action="modfile.php?r=1" method="post">
	...
	<tr><th>File Tracking No.</th><td><input readonly type="text" name="trkno" value="<?php echo ($row['F_TRACK_NO']); ?>"></td></tr>
	<tr><th>File Server Name</th><td><input readonly type="text" name="svname" readonly value="<?php echo $row['F_NAME_SERVER']; ?>"></td></tr>
	<tr><th>File Original Name</th><td><input readonly type="text" name="origname" value="<?php echo $row['F_NAME_ORIG']; ?>"></td></tr>
